...
public class Info {
	...
	public static String tform(HashMap map)
	{
    	...
    	jscode+="{\n";
    	 ...
    	 while(it.hasNext())
    	 {
    	  ...
    	  jscode+="{\n";
    	  jscode+="document.getElementById(\"txt\").src=\"/zhctms_site/upfile/"+map.get("filename")+"\";\n";
    	  jscode+="}\n";
    	 }
    	 jscode+="}\n";
	...
	//System.out.println(a);
	 ...
	 /**
		...
		{
			String jscode = "";
			jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/zhctms_site/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
			jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
			jscode+="<script type=\"text/javascript\"  src=\"/zhctms_site/js/popup.js\"></script>";
			return jscode;
		}
