							...
							<%
								...
								<li class="lm-imgItem">
					                ...
					                <div class="buttons">
											...
											<a class="btn wishlist" href="/zhctms_site/zhctms_site?ac=addfav&goodid=<%=goodsmap.get("id") %>&page=index.jsp" title="收藏此美食"><span class="glyphicon glyphicon-heart"></span></a>
								    </div>
								    <div class="caption">
