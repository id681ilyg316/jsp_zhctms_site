...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="top-link">
						...
						<li><a href="/zhctms_site/admin" target="_blank" ><span
						...
						<li><a href="#" role="button" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1"
									href="/zhctms_site/zhctms_site?ac=frontexit"><i
										class="glyphicon glyphicon-log-out"></i>安全退出</a>
								</li>
								<li><a target="_blank" href="/zhctms_site/admin"><span
								class="glyphicon glyphicon-user"></span> 管理员登录</a>
						</li>
							</ul></li>
						<%
	...
	<header class="container">
		<div class="row">
			<div class="col-md-4">
				<div id="logo">
					<span style="font-size:25px">中华传统美食网</span>
				</div>
			</div>
			<div class="col-md-4">
				<form class="form-search" action="goods.jsp" method="post">
					<input type="text" placeholder="美食名称..."
							...
							<div class="dropdown-inner">
								<ul class="list-unstyled">
									<%
										ArrayList<HashMap> stypelist = (ArrayList<HashMap>) dao
											...
											for (HashMap stypemap : stypelist) {
												if(!"84".equals(stypemap.get("fatherid"))){
													System.out.println(stypemap.get("fatherid"));
									%>
									...
									<%
											...
											%>
											<li><a href="caipus.jsp?key2=<%=stypemap.get("id")%>"><%=stypemap.get("typename")%></a>
									</li>
											<%
										}
											}
