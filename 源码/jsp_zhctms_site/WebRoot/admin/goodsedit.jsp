...
<html lang="en">
  <head>
	...
	<script charset="utf-8" src="/zhctms_site/kindeditor/kindeditor.js"></script>
	<script charset="utf-8" src="/zhctms_site/kindeditor/lang/zh-CN.js"></script>
	<script>
...
uploadJson : '/zhctms_site/kindeditor/jsp/upload_json.jsp',

                fileManagerJson : '/zhctms_site/kindeditor/jsp/file_manager_json.jsp',
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/zhctms_site/zhctms_site?ac=goodsedit&id=<%=id %>" enctype="multipart/form-data">
		        <label>美食名称</label>
  ...
  <div class="modal-footer">
    ...
    <script type="text/javascript">
	    ...
	    function Change_Select(){//当第一个下拉框的选项发生改变时调用该函数
	      ...
	      var url = "/zhctms_site/zhctms_site?ac=searchsontype&fprotype="+ escape(fprotype);
