...
<body>
				...
				<div id="main-content" class="col-md-8">
					...
					<div class="product-desc">
						<ul class="nav nav-tabs">
							<li class="active"><a href="javascript:void(0)" onclick="selectTag('tagContent0',this)">美食描述</a></li>
							<li><a href="javascript:void(0)" onclick="selectTag('tagContent1',this)">美食评价</a></li>
						</ul>
	...
	function tobuy(){     
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/zhctms_site/zhctms_site?ac=tobuy", //servlet的名字     
		          data: "gid="+gid+"&sl="+sl, 
		         success: function(data){       
		    if(data=="true"){     
		    	$("#tsinfo").show();
